 ...
 * 
 * Donde lambda_expression es una implementaci�n del m�todo int valor() que
 * siempre devuelve 5
 * 
 */
public class LambdasFactory {
	...
	/**
	 * Devuelve un inicializador de un array de strings El metodo inicializa recibe
	 * el array ya creado. Su tarea es que todas las posiciones queden inicializadas
	 * con el valor indicado en el seguno parametro del metodo incializa
	 */
